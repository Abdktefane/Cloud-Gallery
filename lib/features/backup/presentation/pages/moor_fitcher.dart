...
//     _runningFetch ??= _fetchNextInner().whenComplete(() => _runningFetch = null);
//   }
...
// extension OrderByWhereExtension<T extends Table, D extends DataClass> on SimpleSelectStatement<T, D> {
